...
<div className="contact-text links">     
        <Row>
          <Col md="12">
            <p><span className="f1">MAKE SURE YOU ARE ON</span><b> MY.ZEL.NETWORK</b></p>
            ...
            <p><span className="f3">All donations goes directly to charity!</span>
              <a href="https://www.zel.network/charity/" target="_blank" data-toggle="tooltip" title="Zelcash Charity"> <span className="f4">More about Zelcash charity</span></a><br/><br/>
            </p>
          </Col>
              </Row>

<a href="https://zel.network" target="_blank" data-toggle="tooltip" title="Website">  <FAHome size={28}/>  </a>
...
<a href="mailto:info@zel.network" target="_blank" data-toggle="tooltip" title="info@zel.network">  <FaEnvelopeO size={28}/>  </a>
    <br/>
</div>
    </div>
        </Container>
